...
namespace Microsoft.OData.Core.E2E.Tests.WriteJsonPayloadTests
{
    ...
    public class SerializationInfoEdgeTests : EndToEndTestBase<SerializationInfoEdgeTests.TestsStartup>
    {
        ...
        public async Task WritingAnEntryWithoutSerializationInfo_WithMetadata_ShouldThrow(string mimeType, bool shouldThrow)
        {
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAFeedWithoutSerializationInfo_WithMetadata_ShouldThrow(string mimeType, bool shouldThrow)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingACollectionWithoutSerializationInfo_WithMetadata_ShouldThrow(string mimeType, bool shouldThrow)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAReferenceLinkWithoutSerializationInfo_WithMetadata_ShouldContainMetadataReference(string mimeType, bool containsMetadataReference)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task SpecifyingSerializationInfoForBothFeedAndEntry_WithMetadata_ShouldUseEntryType(string mimeType, bool containsExpectedTypeInfo)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAnEntryWithWrongEntitySetName_WithMetadata_ShouldGenerateIncorrectMetadata(string mimeType, bool containsWrongMetadata)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAFeedWithAWrongEntitySetName_WithMetadata_ShouldGenerateIncorrectMetadata(string mimeType, bool containsWrongMetadata)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAComplexCollectionWithWrongTypeName_WithMetadata_ShouldHaveMetadataWithIncorrectTypeName(string mimeType, bool containsMetadataWithIncorrectTypeName)
        {
            var settings = CreateODataMessageWriterSettings();
            var responseMessage = CreateTestResponseMessage(mimeType);
            ...
            if (containsMetadataWithIncorrectTypeName)
            {
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingAnEntryWithWrongSerializationInfo_WithEdmModelAndMetadata_ShouldIncludeIncorrectMetadata(string mimeType, bool containsIncorrectMetadata)
        {
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task ChangingSerializationInfoAfterWriteStart_WithMetadata_ShouldUseOriginalMetadata(string mimeType, bool usesOriginalMetadata)
        {
            var settings = new ODataMessageWriterSettings();
            settings.ODataUri = new ODataUri() { ServiceRoot = _baseUri };
        ...
        [InlineData(MimeTypeODataParameterMinimalMetadata, true)]
        [InlineData(MimeTypeODataParameterNoMetadata, false)]
        public async Task WritingEntryWithHandcraftedEdmModel_WithMetadata_ShouldSerializeCorrectlyAndHasMetadataReference(string mimeType, bool hasMetadata)
        {
